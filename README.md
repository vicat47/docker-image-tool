...
本项目采用 [Unlicense](https://unlicense.org) 许可证，即公共领域（public domain）许可。这意味着您可以自由地复制、修改、分发和使用本软件，无论是用于商业还是非商业目的，无需任何许可或授权。

有关完整的法律文本，请参阅项目根目录下的 [LICENSE](LICENSE) 文件。
